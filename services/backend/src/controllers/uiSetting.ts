...
import { UiSettingControllerExpressHttp, UiSettingRepoSequelizePG, UiSettingService } from '@m-cafe-app/backend-logic';


const uiSettingController =
...
uiSettingRouter.get(
  ...
  (async (req, res) => {
    ...
    await uiSettingController.getAllByScope(req, res);
...
uiSettingRouter.post(
  ...
  (async (req, res) => {
    ...
    await uiSettingController.create(req, res);
...
uiSettingRouter.delete(
  ...
  (async (req, res) => {
    ...
    await uiSettingController.remove(req, res);
